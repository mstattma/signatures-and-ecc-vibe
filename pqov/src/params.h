...
#if (!defined(_OV16_160_64))&&(!defined(_OV256_112_44))&&(!defined(_OV256_184_72))&&(!defined(_OV256_244_96))&&(!defined(_OV256_50_20))&&(!defined(_OV256_63_25))

//#define _OV16_160_64
#define _OV256_112_44
// #define _OV256_184_72
// #define _OV256_244_96
// #define _OV256_50_20    // Custom: 80-bit security, 528-bit signature
// #define _OV256_63_25    // Custom: 100-bit security, 632-bit signature
#endif
...
// Custom parameter sets for bandwidth-constrained stego channels
#if defined _OV256_50_20
#define _GFSIZE 256
#define _PUB_N 50
#define _PUB_M 20
#define _HASH_LEN 20
#define PQOV_NAMESPACE_PARAM S80

#elif defined _OV256_63_25
#define _GFSIZE 256
#define _PUB_N 63
#define _PUB_M 25
#define _HASH_LEN 25
#define PQOV_NAMESPACE_PARAM S100
